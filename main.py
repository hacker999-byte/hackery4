...
os.system(f'cls & mode 85,20 & title [HACKER Nuker] - Configuration')
...
class Avery:
    ...
    def Credits(self):
        os.system(f'cls & mode 85,20 & title [Playz Nuker] - Credits')
        print(f'''
                                                 {self.colour}╭╮╱╭╮╱╱╱╱╱╭╮╭━╮╱╱╭━━━╮╱╱╱╭╮╱╭╮
                                                 ┃┃╱┃┃╱╱╱╱╱┃┃┃╭╯╱╱┃╭━╮┃╱╱╱┃┃╱┃┃
                                                 ┃╰━╯┣━━┳━━┫╰╯╯╭━━┫╰━╯┣╮╱╭┫╰━╯┃
    ...
    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title [Playz Nuker] - Themes')
        print(f'''
                                             {self.colour} ╭╮╱╭╮╱╱╱╱╱╭╮╭━╮╱╱╭━━━╮╱╱╱╭╮╱╭╮
                                              ┃┃╱┃┃╱╱╱╱╱┃┃┃╭╯╱╱┃╭━╮┃╱╱╱┃┃╱┃┃
                                              ┃╰━╯┣━━┳━━┫╰╯╯╭━━┫╰━╯┣╮╱╭┫╰━╯┃
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [Playz Nuker] - Connected: {client.user}')
        print(f'''
                              {self.colour}╭╮╱╭╮╱╱╱╱╱╭╮╭━╮╱╱╭━━━╮╱╱╱╭╮╱╭╮
                              ┃┃╱┃┃╱╱╱╱╱┃┃┃╭╯╱╱┃╭━╮┃╱╱╱┃┃╱┃┃
                              ┃╰━╯┣━━┳━━┫╰╯╯╭━━┫╰━╯┣╮╱╭┫╰━╯┃
